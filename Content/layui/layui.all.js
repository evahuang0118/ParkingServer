    ...
    u.prototype.type = function () {
        ...
        u.prototype.view = function () {
            ...
            a.layout = "object" == typeof a.layout ? a.layout : ["prev", "page", "next"],
                ...
                a.prev = "prev" in a ? a.prev : "&#x4E0A;&#x4E00;&#x9801;",
                a.next = "next" in a ? a.next : "&#x4E0B;&#x4E00;&#x9801;";
            var n = a.pages > t ? Math.ceil((a.curr + (t > 1 ? 1 : 0)) / (t > 0 ? t : 1)) : 1,
                i = {
                    ...
                    page: function () {
                        ...
                        if (a.count < 1)
                            return "";
                        n > 1 && a.first !== !1 && 0 !== t && e.push('<a href="javascript:;" class="layui-laypage-first" data-page="1"  title="&#x9996;&#x9801;">' + (a.first || 1) + "</a>");
                        ...
                        return a.pages > t && a.pages > u && a.last !== !1 && (u + 1 < a.pages && e.push('<span class="layui-laypage-spr">&#x2026;</span>'), 0 !== t && e.push('<a href="javascript:;" class="layui-laypage-last" title="&#x5C3E;&#x9801;"  data-page="' + a.pages + '">' + (a.last || a.pages) + "</a>")),
                            e.join("")
                    }
                        (),
                    next: function () {
                    ...
                    skip: function () {
                        return ['<span class="layui-laypage-skip">&#x5230;&#x7B2C;', '<input type="text" min="1" value="' + a.curr + '" class="layui-input">', '&#x9801;<button type="button" class="layui-laypage-btn">&#x78BA;&#x5b9a;</button>', "</span>"].join("")
                    }
                        ()
                };
        ...
        T.prototype.calendar = function (e) {
            ...
            if (l.year < d[0] && (l.year = d[0], r.hint("最低只能支持到公元" + d[0] + "年")), l.year > d[1] && (l.year = d[1], r.hint("最高只能支持到公元" + d[1] + "年")), r.firstDate || (r.firstDate = w.extend({}, l)), c.setFullYear(l.year, l.month, 1), t = c.getDay(), a = n.getEndDate(l.month || 12, l.year), i = n.getEndDate(l.month + 1, l.year), w.each(y, function (e, n) {
                ...
                : r.startDate = r.startDate || {
                    year: l.year,
                    month: l.month
                }, e && (r.listYM = [[r.startDate.year, r.startDate.month + 1], [r.endDate.year, r.endDate.month + 1]], r.list(s.type, 0).list(s.type, 1), "time" === s.type ? r.setBtnStatus("時间", w.extend({}, r.systemDate(), r.startTime), w.extend({}, r.systemDate(), r.endTime)) : r.setBtnStatus(!0))), s.range || (r.listYM = [[l.year, l.month + 1]], r.list(s.type, 0))), s.range && !e) {
                ...
                o = {
                    ...
                    confirm: function () {
                        if (a.range) {
                            ...
                            if (w(e).hasClass(s))
                                return n.hint("time" === a.type ? l.replace(/日期/g, "時间") : l)
                        } else if (w(e).hasClass(s))
                            return n.hint("不在有效日期或時间范围内");
                        n.done(),
                            n.setValue(n.parse()).remove()
                    }
                };
        ...
        p.prototype.upload = function (e, i) {
            ...
            if (v = 0 === v.length ? r.value.match(/[^\/\\]+\..+/g) || [] || "" : v, 0 !== v.length) {
                ...
                if (o.fileLength = function () {
                    ...
                    return o.msg("同時最多只能上传的数量为：" + l.number);
        ...
        D.prototype.renderPicker = function () {
            var e = this,
                ...
                t = e.elemPicker = i(['<div id="layui-colorpicker' + e.index + '" data-index="' + e.index + '" class="layui-anim layui-anim-upbit layui-colorpicker-main">', '<div class="layui-colorpicker-main-wrapper">', '<div class="layui-colorpicker-basis">', '<div class="layui-colorpicker-basis-white"></div>', '<div class="layui-colorpicker-basis-black"></div>', '<div class="layui-colorpicker-basis-cursor"></div>', "</div>", '<div class="layui-colorpicker-side">', '<div class="layui-colorpicker-side-slider"></div>', "</div>", "</div>", '<div class="layui-colorpicker-main-alpha ' + (o.alpha ? n : "") + '">', '<div class="layui-colorpicker-alpha-bgcolor">', '<div class="layui-colorpicker-alpha-slider"></div>', "</div>", "</div>", function () {
                    ...
                    (), '<div class="layui-colorpicker-main-input">', '<div class="layui-inline">', '<input type="text" class="layui-input">', "</div>", '<div class="layui-btn-container">', '<button class="layui-btn layui-btn-primary layui-btn-sm" colorpicker-events="clear">清空</button>', '<button class="layui-btn layui-btn-sm" colorpicker-events="confirm">確定</button>', "</div", "</div>", "</div>"].join(""));
                            ...
                            var h = "string" == typeof r.attr("lay-search"),
                                ...
                                m = t(['<div class="' + (h ? "" : "layui-unselect ") + a, (u ? " layui-select-disabled" : "") + '">', '<div class="' + n + '">', '<input type="text" placeholder="' + p + '" ' + ('value="' + (d ? f.html() : "") + '"') + (h ? "" : " readonly") + ' class="layui-input' + (h ? "" : " layui-unselect") + (u ? " " + c : "") + '">', '<i class="layui-edge"></i></div>', '<dl class="layui-anim layui-anim-upbit' + (r.find("optgroup")[0] ? " layui-select-group" : "") + '">', function (e) {
                                    ...
                                    return layui.each(e, function (e, a) {
                                        ...
                                        0 === t.length && t.push('<dd lay-value="" class="' + c + '">没有選項</dd>'),
                                        t.join("")
                                }
                                    (r.find("*")) + "</dl>", "</div>"].join(""));
                            o[0] && o.remove(),
        ...
        if (layui.each(d, function (e, l) {
            ...
            if (r.removeClass(o), layui.each(c, function (e, t) {
                ...
                if (a[t]) {
                    ...
                    if (f = f || a[t][1], "required" === t && (f = r.attr("lay-reqText") || f), c)
...
layui.define("form", function (e) {
    ...
    g.prototype.config = {
        ...
        g.prototype.render = function () {
            ...
            if (r[0]) {
                if (a.showSearch && n.prepend('<input type="text" class="layui-input layui-tree-search" placeholder="请输入关键字进行过滤">'), e.key = a.id || e.index, e.elem = n, e.elemNone = i('<div class="layui-tree-emptyText">' + a.text.none + "</div>"), r.html(e.elem), 0 == e.elem.find(".layui-tree-set").length)
                    ...
                    h = i(['<div data-id="' + l.id + '" class="layui-tree-set' + (l.spread ? " layui-tree-spread" : "") + (l.checked ? " layui-tree-checkedFirst" : "") + '">', "<div " + (r.drag && !l.fixed ? 'draggable="true"' : "") + ' class="layui-tree-entry">', '<div class="layui-tree-main">', function () {
                        ...
                        (), "</div>", function () {
                            ...
                            return r.edit === !0 && (r.edit = ["update", "del"]),
                                "object" == typeof r.edit ? (layui.each(r.edit, function (a, n) {
                                    i.push(e[n] || "")
                                }), i.join("") + "</div>") : void 0
                        }
                        (), "</div></div>"].join(""));
        ...
        g.prototype.spread = function (e, a) {
            ...
            k.on("click", function (i) {
                ...
                if (a[0]) {
                    if (e.hasClass(v))
                        e.removeClass(v), a.slideUp(200), n.removeClass(h).addClass(o);
            ...
            l.children(".layui-tree-btnGroup").on("click", ".layui-icon", function (l) {
                ...
                if ("add" == f) {
                    ...
                    if (w.title = r.text.defaultNodeName, w.id = b, n.tree(e.children("." + y), [w]), r.showLine)
                        if (g[0])
                            g.hasClass(k) || g.addClass(k), e.find("." + y).each(function () {
                    ...
                    if (r.operate && r.operate(x), x.status = "remove", !e.prev("." + s)[0] && !e.next("." + s)[0] && !e.parent("." + y)[0])
                        return e.remove(), void n.elem.append(n.elemNone);
                    if (e.siblings("." + s).children("." + u)[0]) {
                        ...
                        if (r.showLine) {
                            ...
                            H.find(".layui-tree-iconArrow").addClass(t);
            ...
            e.elem.on("dragstart", "." + u, function () {
                ...
                e.elem.on("dragend", "." + u, function (n) {
                    var n = n || event,
                        ...
                        L = d.next()[0];
                    if (T)
                        var N = d.parent("." + y), A = d.parents("." + s).eq(0), q = A.parent("." + y), F = A.offset().top, I = d.siblings(), H = A.children("." + y).children("." + s).length;
                    var S = function (n) {
                        if (T || L || e.elem.children("." + s).last().children("." + y).children("." + s).last().addClass(C), !T)
                            return void d.removeClass("layui-tree-setHide");
                        if (1 == H)
                            a.showLine ? (n.find("." + c).removeClass("layui-tree-icon"), n.find("." + c).children(".layui-icon").removeClass(h).addClass("layui-icon-file"), q.addClass(k), q.children("." + s).children("." + y).each(function () {
                                i(this).children("." + s).last().addClass(C)
                    ...
                    g.each(function () {
                        if (0 != i(this).height()) {
                            ...
                            if (r > n && r < n + 15) {
                                if (i(this).children("." + y)[0] || (a.showLine ? (i(this).find("." + c).eq(0).addClass("layui-tree-icon"), i(this).find("." + c).eq(0).children(".layui-icon").addClass(o).removeClass("layui-icon-file")) : i(this).find(".layui-tree-iconArrow").removeClass(t), i(this).append('<div class="layui-tree-pack"></div>')), i(this).children("." + y).append(d), S(A), a.showLine) {
                                    ...
                                    if (d.children("." + y).children("." + s).last().addClass(C), 1 == l.length) {
                                        ...
                                        d.prev("." + s).hasClass(C) ? (d.prev("." + s).removeClass(C), d.addClass(C)) : (d.removeClass("layui-tree-setLineShort layui-tree-setHide"), d.children("." + y)[0] ? d.prev("." + s).children("." + y).children("." + s).last().removeClass(C) : d.siblings("." + s).find("." + y).each(function () {
                                            i(this).children("." + s).last().addClass(C)
                            ...
                            if (r < n) {
                                if (i(this).before(d), S(A), a.showLine) {
                                    ...
                                    if (b[0]) {
                                        ...
                                        T.hasClass(k) || T.addClass(k), T.find("." + y).each(function () {
                                            i(this).children("." + s).last().addClass(C)
                                        });
                            ...
                            if (r > w)
                                return e.elem.children("." + s).last().children("." + y).addClass(m), e.elem.append(d), S(A), d.prev().children("." + y).children("." + s).last().removeClass(C), d.addClass("layui-tree-setHide"), d.children("." + y).children("." + s).last().addClass(C), a.dragend && a.dragend("拖拽成功，插入最外层节点", d, e.elem), !1
                        }
                    })
                })
        },
        ...
        g.prototype.setChecked = function (e) {
            ...
            a.elem.find("." + s).each(function (a, n) {
                ...
                if ("number" == typeof e) {
                    if (r == e)
                        return l[0].checked || t.click(), !1
                } else
                    i.inArray(r, e) != -1 && (l[0].checked || t.click())
            })
        },
        l.that = {},
        l.config = {},
                    ...
                    t.ajax({
                        ...
                        success: function (t) {
                            "function" == typeof a.parseData && (t = a.parseData(t) || t),
                                t[n.statusName] != n.statusCode ? (i.renderForm(), i.errorView(t[n.msgName] || '返回的數據不符合規範，正确的成功狀態碼應為："' + n.statusName + '": ' + n.statusCode)) : (i.renderData(t, e, t[n.countName]), o(), a.time = (new Date).getTime() - i.startTime + " ms"),
                                i.setColsWidth(),
                                "function" == typeof a.done && a.done(t, e, t[n.countName])
                        },
                        error: function (e, t) {
                            i.errorView("數據請求異常：" + t),
                                i.renderForm(),
                                i.setColsWidth()
                        }
                    })
    ...
    var e = layui.$,
        i = {
            ...
            timeAgo: function (t, e) {
                ...
                return a > 6912e5 ? (a = new Date(t), n[0][0] = i.digit(a.getFullYear(), 4), n[0][1] = i.digit(a.getMonth() + 1), n[0][2] = i.digit(a.getDate()), e || (n[1][0] = i.digit(a.getHours()), n[1][1] = i.digit(a.getMinutes()), n[1][2] = i.digit(a.getSeconds())), n[0].join("-") + " " + n[1].join(":")) : a >= 864e5 ? (a / 1e3 / 60 / 60 / 24 | 0) + "天前" : a >= 36e5 ? (a / 1e3 / 60 / 60 | 0) + "小時前" : a >= 12e4 ? (a / 1e3 / 60 | 0) + "分鐘前" : a < 0 ? "未来" : "剛剛"
            },
            digit: function (t, e) {
                var i = "";
                t = String(t),
        ...
        k = function (t) {
            var e = this,
                l = i.open({
                    ...
                    title: "插入代码",
                    skin: "layui-layer-msg",
                    content: ['<ul class="layui-form layui-form-pane" style="margin: 15px;">', '<li class="layui-form-item">', '<label class="layui-form-label">請選擇語言</label>', '<div class="layui-input-block">', '<select name="lang">', '<option value="JavaScript">JavaScript</option>', '<option value="HTML">HTML</option>', '<option value="CSS">CSS</option>', '<option value="Java">Java</option>', '<option value="PHP">PHP</option>', '<option value="C#">C#</option>', '<option value="Python">Python</option>', '<option value="Ruby">Ruby</option>', '<option value="Go">Go</option>', "</select>", "</div>", "</li>", '<li class="layui-form-item layui-form-text">', '<label class="layui-form-label">代码</label>', '<div class="layui-input-block">', '<textarea name="code" lay-verify="required" autofocus="true" class="layui-textarea" style="height: 200px;"></textarea>', "</div>", "</li>", '<li class="layui-form-item" style="text-align: center;">', '<button type="button" lay-submit lay-filter="layedit-code-yes" class="layui-btn"> 確定 </button>', '<button style="margin-left: 20px;" type="button" class="layui-btn layui-btn-primary"> 取消 </button>', "</li>", "</ul>"].join(""),
                    success: function (l, n) {
