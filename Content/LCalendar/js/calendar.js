...
(function (root, factory) {
	...
	var Calendar = function () {
		...
		this.isShow = false;
		this.autohide = true;
		this.toolbarTpl = '<div class="ui-calendar-toolbar clearfix"><a class="js-calendar-submit">確定</a><a class="js-clear">清空</a><a class="ui-calendar-today">現在</a><a class="ui-calendar-close">關閉</a></div>';
		this.timeTpl = '<div class="ui-calendar-time clearfix"><select class="js-calendar-hours">時</select>:<select class="js-calendar-minutes">分</select><s>:</s><select class="js-calendar-second">秒</select></div>';
		this.dateArr = [];
		this.maxDays = 9999;
	};
	Calendar.prototype = {
		...
		bindEvent: function () {
			...
			$('.ui-calendar-toolbar', _this.calendarContainer).delegate('a', 'click', function () {
				if ($(this).hasClass('js-calendar-submit')) { //点確定
